...
> **Current release:** 1.12.0. The project is migrating from the original `StatusEmbed` facade to focused services and a configurable automation engine.
...
3. Copy `DiscordSRVStatusEmbed-1.12.0.jar` into `plugins/`.
