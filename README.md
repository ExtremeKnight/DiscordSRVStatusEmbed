...
> **Current release:** 1.9.0. The project is a single-plugin implementation centered on `me.example.statusembed.StatusEmbed`.
...
3. Copy `DiscordSRVStatusEmbed-1.9.0.jar` into `plugins/`.
